...
class ClassificationAlgorithms:
   ...
   def feedforward_neural_network(
    ...
    # Ensure train_X and test_X are numeric
    train_X = train_X.select_dtypes(include=[np.number])
    test_X = test_X.select_dtypes(include=[np.number])
    
    # Ensure train_y is numeric
    train_y = train_y.select_dtypes(include=[np.number])
    
    print(f"Initial train_X shape: {train_X.shape}, train_y shape: {train_y.shape}")
    ...
    print(f"Model fitted. train_X shape: {train_X.shape}, train_y shape: {train_y.shape}")
